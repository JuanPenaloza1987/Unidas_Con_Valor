...
import com.creatio.imm.Adapters.ADDetailCBusiness;
...
public class Categorie_detail extends AppCompatActivity {
    ...
    public void ReadCuponsCategory(){
        final SkeletonScreen skeletonScreen = Skeleton.bind(lvDetail)
                ...
                .show();
        data.clear();
        String url = "ReadCuponsCategoryBusiness";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (success.equalsIgnoreCase("true")) {
                        ...
                        if(extras.getString("words", "0").equalsIgnoreCase("")) {
                            JSONArray arr = response.getJSONArray("data");
                            for (int i = 0; i < arr.length(); i++) {
                                JSONObject obj = arr.getJSONObject(i);
                                String ID = obj.optString("ID");
                        ...
                        if(extras.getString("words", "0").equalsIgnoreCase("")){
                            ADDetailCBusiness adapter = new ADDetailCBusiness(context, data,extras.getString("category", "0"));
                            lvDetail.setAdapter(adapter);
                            skeletonScreen.hide();
                        }else{
