...
public class ADColsAU extends ArrayAdapter<OCitys> implements Filterable {
    Context context;
    ...
    public ADColsAU(@NonNull Context context, int resource, ArrayList<OCitys> data) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        txtTitle.setText(filterdata.get(i).getCity());
