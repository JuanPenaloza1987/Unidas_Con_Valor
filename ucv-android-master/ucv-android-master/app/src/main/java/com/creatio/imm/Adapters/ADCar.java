...
public class ADCar extends BaseAdapter {
    ...
    public ADCar(Context context, ArrayList<OCar> data) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        Button btnLess = item.findViewById(R.id.btnLess);
        Button btnMore = item.findViewById(R.id.btnMore);
    ...
    public void UpdateCar(String ID, String quantity) {
        AndroidNetworking.post(R.string.apiurl + "UpdateCar")
                .addBodyParameter("ID", ID)
