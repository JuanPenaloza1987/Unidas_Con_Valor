...
public class EditPerfilTarjeta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_perfil_tarjeta);
        //extraemos los datos enviados de la pantalla anterior.
        datos=getIntent().getExtras();
        context = EditPerfilTarjeta.this;
        prefs = PreferenceManager.getDefaultSharedPreferences(context);
        ids = datos.getString("ids");
        numTarjeta = datos.getString("numTarjeta");
        String numTar = datos.getString("numTarjeta");
        String name = datos.getString("name");
        String last_name = datos.getString("last_name");
        String middle_name = datos.getString("middle_name");
        String photograph = datos.getString("photo");
    ...
    private View.OnClickListener onclickContinuar = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (validarCampos()){
                uploadImage();
                final Intent i = new Intent(EditPerfilTarjeta.this,Contactos_Tarjeta.class);
                i.putExtra("ids",ids);
                i.putExtra("numTarjeta",numTarjeta);
                startActivity(i);
            }else{
                Alerter.create(EditPerfilTarjeta.this)
    ...
    private View.OnClickListener onclickRegresar1 = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            final Intent i = new Intent(EditPerfilTarjeta.this,TarjetaUnidos.class);
            startActivity(i);
        }
    };
