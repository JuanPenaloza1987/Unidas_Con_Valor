...
public class activityComentarios extends AppCompatActivity {
    ...
    public void onBackPressed() {
        if (webView.canGoBack()){
            ...
            finish();
            Intent intent = new Intent(activityComentarios.this, TarjetaMenuIniActivity.class);
    ...
    private View.OnClickListener onclickRegress = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            final Intent i = new Intent(activityComentarios.this,TarjetaMenuIniActivity.class);
            i.putExtra("ids",id);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, getResources().getString(R.string.apiurl)+"GetUrls", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    Alerter.create(activityComentarios.this)
                            .setTitle("Oh oh")
